...
public class Autoplay {
    ...
    public static int riskOfStuck(Game game, ArrayList<Integer> invalidMoves) {
        ...
        right.act2(Location.RIGHT);
        left.act2(Location.LEFT);
        down.act2(Location.DOWN);

        ArrayList<Integer> chanceOfStuck = new ArrayList<>();

        double riskDown = down.getGrid().eval();
        double riskRight = right.getGrid().eval();
        double riskLeft = left.getGrid().eval();
